...
The biggest difference between formalization of labeled transition systems in their choise of how to represent the transition system.
In the present formalization the set of nodes is a type rather, and a labeled transition system is represented as a locale fixing a set 
of transition where each transition is a triple of respectively a start node, a label and an end node.
